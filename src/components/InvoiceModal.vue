    ...
    <form @submit.prevent="submitForm" class="invoice-content">
      ...
      <div class="bill-from flex flex-column">
        ...
        <div class="location-details flex">
          <div class="input flex flex-column">
            <label for="billerCity">Двигун</label>
      ...
      <div class="bill-to flex flex-column">
        <h4>Куди доставка</h4>
        <div class="input flex flex-column">
          <label for="clientName">Прізвище імя замовника</label>
          <input required type="text" id="clientName" v-model="clientName" />
        </div>
        <div class="input flex flex-column">
          <label for="clientEmail">емейл замовника</label>
      ...
      <div class="invoice-work flex flex-column">
        ...
        <div class="input flex flex-column">
          <label for="paymentTerms">Період доставки </label>
          <select required type="text" id="paymentTerms" v-model="paymentTerms">
            <option value="1">В дорозі днів 1</option>
            <option value="2">В дорозі днів 2</option>
            <option value="3">В дорозі днів 3</option>
            <option value="4">В дорозі днів 4</option>
            <option value="5">В дорозі днів 5</option>
            <option value="6">В дорозі днів 6</option>
            <option value="7">В дорозі днів 7</option>
            <option value="8">В дорозі днів 8</option>
            <option value="9">В дорозі днів 9</option>
            <option value="10">В дорозі днів 10</option>
          </select>
        </div>
        <div class="input flex flex-column">
